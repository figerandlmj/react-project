		...
		return (
			<header>
				<Row>
					...
					<Col span={16}>
						<Menu mode="horizontal" onClick={this.bandleClick.bind(this)} selectedKeys={[this.state.current]}>
							<Menu.Item key="top"><Icon type="appstore" />头条</Menu.Item>
							<Menu.Item key="shehui"><Icon type="appstore" />社会</Menu.Item>
							<Menu.Item key="toutiao"><Icon type="appstore" />国内</Menu.Item>
							...
							<Menu.Item key="shijian"><Icon type="appstore" />时间</Menu.Item>
							{userShow}
						</Menu>
